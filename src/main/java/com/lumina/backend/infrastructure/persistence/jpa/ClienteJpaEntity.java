...
public class ClienteJpaEntity {
    ...
    private ClienteJpaEntity clienteIndicacao;

    @ManyToOne
    @JoinColumn(name = "fk_responsavel")
    private ClienteJpaEntity responsavel;
    ...
    public ClienteJpaEntity getClienteIndicacao() {
        return clienteIndicacao;
    }

    public void setClienteIndicacao(ClienteJpaEntity clienteIndicacao) {
        this.clienteIndicacao = clienteIndicacao;
    }

    public ClienteJpaEntity getResponsavel() {
        return responsavel;
    }

    public void setResponsavel(ClienteJpaEntity responsavel) {
