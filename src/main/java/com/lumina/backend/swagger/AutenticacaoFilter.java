...
public class AutenticacaoFilter extends OncePerRequestFilter {
    ...
    private final com.lumina.backend.swagger.   GerenciadorTokenJwt jwtTokenManager;

    public AutenticacaoFilter(AutenticacaoService autenticacaoService, com.lumina.backend.swagger.  GerenciadorTokenJwt jwtTokenManager) {
